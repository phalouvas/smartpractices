...
frappe.ui.form.on("Register Company", {
    refresh(frm) {
        if (!frm.doc.__islocal) {
            ...
            '<p><b>' + frm.doc.company_name + '</b> (term which includes its every time subsidiaries and other connected companies), herein called “<b>' + frm.doc.company_name + '</b>”, may collect, process, store and transfer any personal data related to you in accordance of the applicable Processing of Personal Data Protection Laws. </p>'
            + '<p>Data includes information relating to you which has been given or shall be given to <b>' + frm.doc.company_name + '</b> to carry out its internal due diligence process, client acceptance or engagement procedures, in reference to applicable legal and/or regulatory requirements or for quality review purposes: </p>'
            + '<p><ul><li>during the submission of applications and any other documents</li>'
            + '<li>has been extracted through the execution of your instructions and in general through services rendered to you by <b>' + frm.doc.company_name + '</b>. </li></ul></p>'
